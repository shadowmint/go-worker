...
const TEST_ROOT_URI = "root:uandUinal7@tcp(localhost:3306)/?charset=utf8&autocommit=true"
const TEST_URI = "root:uandUinal7@tcp(localhost:3306)/testing?charset=utf8&autocommit=true"
